...
<div>
<tile:insertAttribute name="searchContent"/>
</div>
<div class="tablectrl">
	<div id="toolbar" class="Clearfix">
		<div class="f-left col-divided-2">
			<!-- Toolbar div Back -->
			<ul>
				<li><a href="#" id="btnBack">Back To Project Management</a></li>
			</ul>
			...
			<ul>
				...
				<li><a href="createNewPricePlan.htm">Create Price Plan</a></li>
			</ul>
			<!-- end Price Plan menu-->
		...
		<div class="f-left col-divided-2">
			...
			<ul>
				...
				<li><a href="searchToolPlans.htm">Search Price Plan Rate Records</a></li>
				...
				<li><a href="#" id="btnExtract">Extract a Price Plan Records</a></li>
...
$(document).ready(function(){
	...
	$("#btnBack").click(function(){
		...
		//window.location.href = "pricePlanList.htm";
	});
	...
	$('#searchPricePlan').click(function(){
		...
		SEVENJ.redirect('searchToolPlans.htm');
	});
