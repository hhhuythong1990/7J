...
<div class="bell-window-content">
	<div class="contenttable">
		<div class="introText" style="border-bottom: 1px dotted #CCCCCC;">
			<p>Edit price plan page for project #${webSession.currentProject.projectId }</p>
		</div>
					...
					<tr >
						...
						<td width="40%">
							<div>
								...
								<input type="hidden" id="originalPricePlanCode" name="originalPricePlanCode"/>	
							</div>
...
$(document).ready(function () {
	$('#originalPricePlanCode').val($('#pricePlanCode').val());
	$('#pricePlanCode').prop('disabled',true);
});
</script>
